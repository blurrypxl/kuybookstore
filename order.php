...
<head>
	<title>Tokobuku - Orderan Saya</title>
	<!-- for-mobile-apps -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Tokobuku" />
		...
		<div class="container">
			...
			<div class="checkout-left">
				...
				<div class="checkout-right-basket">
					<a href="daftarorder.php"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Kembali</a>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
